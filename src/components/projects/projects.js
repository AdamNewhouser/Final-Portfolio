        ...
        <div className="Projects__content">
          ...
          <div className="App__item">
            ...
            <p className="description">
              A project management app. Helps small businesses overcome the
              issue of a lack of quality, non-enterprise management software by
              providing a clean, easy to use interface to manage multiple
          ...
          <div className="App__item">
            ...
            ></img>
            <p className="description">
              A quiz structured as a series of basic questions and responses
              that demonstrate my ability to understand user flow, navigate the
              user through different page views, give feedback to the user based
              on input received, and give the user a final score based on the
              combined result of each question.
            </p>
            <ul className="techs">
              <li className="tech">
                <FontAwesomeIcon icon={faJsSquare} size="2x" />
